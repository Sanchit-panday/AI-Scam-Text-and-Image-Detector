...
import { Braces, MessageCircle, MessageSquareDot, MessageSquareText, SearchCheck, Signature } from "lucide-react";
        ...
        <>
            ...
            <header className="flex min-h-70 md:min-h-90 justify-center items-center">
                <div className="flex flex-col items-center gap-4 text-center">
                    <h2 className="text-primary text-4xl font-semibold">MildyAI Resources</h2>
