"use client"
import { DnsLookupResult, ScanMeta } from "@/types/types";
import { getDnsLookup } from "./getDnsLookup";
import { useRef, useState } from "react";
import { AlertCircle, FileText, Send, X } from "lucide-react";
import ErrorAlert from "@/components/Error";
import LoadingSpinner from "@/components/LoadingSpinner";
import DnsLookupCard from "@/components/ResultCards/DNSLookupCard";
...
export default function page() {
    ...
    const dnsLookup = async (url: string) => {
        ...
        try {
            ...
            const data = await getDnsLookup(url);
        ...
        <>
            ...
            <div className="space-y-6 max-w-3xl">
                ...
                {/* {result && scanMeta && !loading && (
                    <DnsLookupCard DnsLookupResult={result}
                        scanMeta={scanMeta}
                    />
                )} */}
                {result && scanMeta && !loading && (
